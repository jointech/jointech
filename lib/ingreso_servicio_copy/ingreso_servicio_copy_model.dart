...
import 'ingreso_servicio_copy_widget.dart' show IngresoServicioCopyWidget;
import 'package:flutter/material.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class IngresoServicioCopyModel
    extends FlutterFlowModel<IngresoServicioCopyWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  final formKey = GlobalKey<FormState>();
  InstantTimer? instantTimer;
  // Stores action output result for [Custom Action - checkInternet] action in ingresoServicioCopy widget.
  bool? estaConectado;
