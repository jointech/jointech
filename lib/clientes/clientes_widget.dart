...
import '/components/crear_cliente_widget.dart';
...
class _ClientesWidgetState extends State<ClientesWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Clientes'});
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ClienteRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClienteRecord> clientesClienteRecordList = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('CLIENTES_arrow_back_rounded_ICN_ON_TAP');
                  context.pop();
                },
              ),
              title: Text(
                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('CLIENTES_PAGE_Icon_2zf42fg0_ON_TAP');
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: const CrearClienteWidget(),
                              ),
                            );
                          },
                  ...
                  if (!FFAppState().searchActive)
                    Expanded(
                      child: Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final clientes = clientesClienteRecordList.toList();
                              ...
                              itemBuilder: (context, clientesIndex) {
                                ...
                                return Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'CLIENTES_PAGE_Container_zvc5jsdf_ON_TAP');
                                            ...
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                valueOrDefault<String>(
                                                  clientesItem.logo,
                                                  'https://tractian.com/website/pages/modelo-ordem-de-servico/es/orden-de-trabajo-header.png',
                                                ),
                                                width: 60.0,
                                                height: 60.0,
                                                fit: BoxFit.cover,
