...
import 'ingreso_servicio_model.dart';
export 'ingreso_servicio_model.dart';

class IngresoServicioWidget extends StatefulWidget {
  const IngresoServicioWidget({
    super.key,
    required this.ot,
    required this.vin,
  });
  ...
  @override
  State<IngresoServicioWidget> createState() => _IngresoServicioWidgetState();
}

class _IngresoServicioWidgetState extends State<IngresoServicioWidget> {
  late IngresoServicioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IngresoServicioModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ingresoServicio'});
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('INGRESO_SERVICIO_arrow_back_ios_new_ICN_');
                  context.safePop();
                },
              ),
            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'INGRESO_SERVICIO_PAGE_FECHA_BTN_ON_TAP');
                                  ...
                                  StreamBuilder<List<ClienteRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        options: dropClienteClienteRecordList
                                            .map((e) => e.nombre)
                                            .toList(),
                                        onChanged: (val) => setState(() =>
                                            _model.dropClienteValue = val),
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          'Describa el detalle del trabajo',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily: 'Outfit',
                                    ...
                                    children: [
                                      TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: 'Fecha control técnico',
                                          hintStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium
                                                  .override(
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'INGRESO_SERVICIO_DatePickerHora_ON_TAP');
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'INGRESO_SERVICIO_PAGE_hora_ON_TAP');
                                  ...
                                  TextFormField(
                                    ...
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Describa el diagnostico',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily: 'Outfit',
                    ...
                    children: [
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'INGRESO_SERVICIO_PAGE_GUARDAR_BTN_ON_TAP');
                              ...
                              ...mapToFirestore(
                                {
                                  ...
                                  'horaFinTecnico':
                                      FieldValue.serverTimestamp(),
                                  'trabajoInicio': FieldValue.serverTimestamp(),
