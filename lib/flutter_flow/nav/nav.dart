...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/ingresoServicio',
          builder: (context, params) => IngresoServicioWidget(
            ot: params.getParam(
              'ot',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'Rendiciones',
          path: '/rendiciones',
          builder: (context, params) => const RendicionesWidget(),
        ),
        FFRoute(
          name: 'MisOrdenes',
          path: '/misOrdenes',
          builder: (context, params) => const MisOrdenesWidget(),
        ),
        FFRoute(
          name: 'Clientes',
          path: '/clientes',
        ...
        FFRoute(
          name: 'VerMiAgenda',
          path: '/verMiAgenda',
          builder: (context, params) => VerMiAgendaWidget(
            miagenda: params.getParam(
              'miagenda',
        ...
        FFRoute(
          name: 'VerMiRendicion',
          path: '/verMiRendicion',
          builder: (context, params) => const VerMiRendicionWidget(),
        ),
        FFRoute(
          name: 'ingresoServicioCopy',
          path: '/ingresoServicioCopy',
          builder: (context, params) => IngresoServicioCopyWidget(
            ot: params.getParam(
              'ot',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'ingresoServicioCopyCopy',
          path: '/ingresoServicioCopyCopy',
          builder: (context, params) => IngresoServicioCopyCopyWidget(
            vin: params.getParam(
              'vin',
              ParamType.String,
            ),
